...
# install phpmyadmin
curl -L -O http://garr.dl.sourceforge.net/project/phpmyadmin/phpMyAdmin/4.2.11/phpMyAdmin-4.2.11-english.tar.gz
tar -xzvf phpMyAdmin-4.2.11-english.tar.gz
mv phpMyAdmin-4.2.11-english /usr/share/phpmyadmin
rm phpMyAdmin-4.2.11-english.tar.gz
